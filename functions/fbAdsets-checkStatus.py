...
def lambda_handler(event, context):
    ...
    adsets_queued = int(event['adsets_queued'])
    ...
    slack_post_message(channel_id, token, f':tada: {message_count} adsets created! :tada:')
    if adsets_queued > message_count:
        slack_post_message(channel_id, token, f':warning: There are {adsets_queued - message_count} adsets that have not been created! :warning:')
