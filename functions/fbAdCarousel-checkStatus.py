...
def lambda_handler(event, context):
    ...
    carousels_queued = int(event['carousels_queued'])
    ...
    slack_post_message(channel_id, token, f':tada: {message_count} carousels created! :tada:')
    if carousels_queued > message_count:
        slack_post_message(channel_id, token, f':warning: There are {carousels_queued - message_count} carousels that have not been created! :warning:')
