...
def lambda_handler(event, context):
    ...
    admedia_queued = int(event['admedia_queued'])
    ...
    slack_post_message(channel_id, token, f':tada: {message_count} pieces of admedia created! :tada:')
    if admedia_queued > message_count:
        slack_post_message(channel_id, token, f':warning: There are {admedia_queued - message_count} pieces of admedia that have not been created! :warning:')
